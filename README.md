...
│   ├── Migrations/
│   │   └── 20260303095818_InitialCreate.cs    # Initial schema migration
│   └── Services/
...
SQLite keeps the stack simple and self-contained — no external database server needed. On Azure, the database file persists at the app's writable path across restarts.
