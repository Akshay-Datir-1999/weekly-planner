        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeekCycleId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Client issue", true, "Fix login bug" },
                    { 2, 1, "Client feature", true, "New customer dashboard" },
                    { 3, 2, "Tech debt cleanup", true, "Refactor auth module" },
                    { 4, 2, "Performance improvement", true, "Database indexing" },
                    { 5, 3, "R&D exploration", true, "AI research spike" },
                    { 6, 3, "R&D optimization", true, "Cloud cost analysis" }
                });
