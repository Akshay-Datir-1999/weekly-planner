...
describe('AppStateService - ULTIMATE 100% Coverage', () => {
  ...
  describe('Toast Messages with Auto-Clear', () => {
    it('should show toast and auto-clear after 3 seconds', (doneFn: jasmine.DoneFn) => {
    ...
    it('should overwrite previous toast', (doneFn: jasmine.DoneFn) => {
  ...
  describe('Error Messages with Auto-Clear', () => {
    it('should show error and auto-clear after 5 seconds', (doneFn: jasmine.DoneFn) => {
    ...
    it('should handle multiple error displays', (doneFn: jasmine.DoneFn) => {
